...
export function initRiskEngine() {
  const dataDir = "/Users/mahatva/Desktop/ET/data";
  const configDir = "/Users/mahatva/Desktop/ET/config";
...
function triggerIncidentWorkflow(sensor, telemetry, severity, exceededBounds) {
  ...
  const zonePermits = permitsData.filter(p => p.zone_id === zoneNum && p.status === "ACTIVE");
